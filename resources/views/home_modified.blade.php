          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <div class="art-avatar">
                <a data-fancybox="avatar" href="{{  asset('assets/img/face-1.jpg') }}" class="art-avatar-curtain">
                  <img src="{{ asset('assets/img/face-1.jpg') }}" alt="avatar">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="art-a art-banner" style="background-image: url({{ asset('assets/img/bg.jpg') }})">
                      ...
                      <div class="art-banner-overlay">
                        ...
                        <!-- main title end -->
                        <!-- photo -->
                        <img src="{{ asset('assets/img/face-2.png') }}" class="art-banner-photo" alt="Your Name">
                      </div>
                      <!-- banner overlay end -->
                    </div>
                    <!-- banner end -->
